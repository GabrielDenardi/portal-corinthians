...
export const siteNavigation: NavItem[] = [
  ...
  { label: "Próximo jogo", href: "/jogos" },
  { label: "Últimas", href: "/#ultimas" },
  { label: "Categorias", href: "/categorias/profissional" },
...
export const footerLinkGroups: FooterGroup[] = [
  {
    ...
    links: [
      ...
      { label: "Cobertura editorial", href: "/categorias/profissional" },
  ...
  },
  {
    title: "Editorias",
    links: [
      { label: "Profissional", href: "/categorias/profissional" },
      { label: "Feminino", href: "/categorias/feminino" },
      { label: "Base", href: "/categorias/base" },
    ],
  },
  {
    title: "Institucional",
